...
parser$add_argument("--input_path", type="character", help="Path to input files") # analyses/BD folder
parser$add_argument("--output_path", type="character", help="Path to output figures") # figures/BD folder
